    ...
    return (
        <div id="projects" className="bg-gray-100  py-10">
            <div className="flex flex-col max-w-6xl mx-auto px-6">
                <h1 className="md:text-lg text-center font-medium mb-12">
                    FEATURED PROJECTS
                </h1>
                ...
                {projects.map((project, index) => (
                    <div
                        key={project.id}
                        className={
                            // Base: flex-col on mobile
                            // Reversed on desktop for even indexes
                    ...
                    >
                        ...
                        <div 
                            className={
                                // Height auto on mobile, 600px on md+
                                'w-full md:w-1/2 flex items-center ' +
                                'h-[400px] md:h-[600px]'
                            }
                        >
                            <PCBViewer
                        ...
                        <div className="w-full md:w-1/2 flex flex-col justify-center items-start ">
                            <h2 className="font-medium mb-2 md:text-base text-sm">
                                {project.title}
                            </h2>
                            <p className="md:text-base text-sm mb-4">
                                {project.description}
                            </p>
                            {/* Example link if you want it visible */}
                            <a
                                href={project.link}
                                target="_blank"
