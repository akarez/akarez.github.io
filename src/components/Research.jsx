        ...
        <div id="research" className='bg-gray-100 py-20'>
            <div className='max-w-4xl mx-auto px-6'>
                ...
                <div className='mb-8'>
                    ...
                    <p className=''>In Proceedings of the Great Lakes Symposium on VLSI (GLSVLSI), 2024</p>
                    <div className='flex mt-2 space-x-4'> 
                        <a href={PEPHS} target='_blank' rel='noopener noreferrer'>
                            <button className='bg-black text-white py-0.5 px-2 rounded hover:bg-gray-500 text-xs'>
                                PDF
                            </button>
                        </a>
                ...
                <div className='mb-8'>
                    ...
                    <p className=''>IFIP International Internet of Things (IoT) Conference, 2023</p>
                    <div className='flex mt-2 space-x-4'> 
