...
function Home() {
    const profileURL = 'https://raw.githubusercontent.com/akarez/akarez.github.io/main/src/assets/samirahmed-pfp.png';
    const resumeURL = 'https://raw.githubusercontent.com/akarez/akarez.github.io/main/src/assets/samirahmed-resume.pdf';
        ...
        <div id='home' className='flex flex-col justify-center items-center md:h-[80vh] h-[70vh] bg-gray-100 py-10'>
            <div className='flex flex-col md:flex-row w-full max-w-6xl md:transform md:-translate-x-24'>
                <div className='flex justify-center md:justify-end w-full md:w-1/2 mb-8 md:mb-0 px-16'>
                    <img src={profileURL} alt='Samir Ahmed' className='object-cover rounded-md hidden md:block' />
                </div>
                <div className='flex flex-col justify-center items-start w-full md:w-1/2 pl-8'>
                    ...
                    <div className='flex mt-5 space-x-5'>
                        <a href={resumeURL} target='_blank' rel='noopener noreferrer' className='transition-transform duration-300 hover:scale-110'>
